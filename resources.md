...
* [2023 Qualifier Link](https://people.cs.vt.edu/gracanin/qualifier/2023/)
* [2024 Qualifier Link](https://people.cs.vt.edu/~gulzar/qualifier/sp2024/)
...
* [VT Templates](https://www.overleaf.com/gallery/tagged/vt)


## <a name="Calendars"></a>VT run calendars<a href="#Calendars"><i class="fa fa-link" aria-hidden="true"></i></a>

* The [general webpage](https://vtnews.vt.edu/calendars.html) for looking at calendars
* A more detailed insight into VT calendars [here](https://www.calendar.vt.edu/main.php?view=subscribe); to add these calendars to your GMail calendar
    1. copy the subscribe url
    2. paste the url into the “Add calendar from URL” Menu
    3. replace the webcal:/// with https://

* The Grad Council [Calendar link](https://calendar.google.com/calendar/u/0?cid=dnQuZWR1X240bnQ0aGdlNTBrdjdqajFjZDN1NzllaW1rQGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20)

## <a name="Printing"></a>Printing and Web Hosting<a href="#Printing"><i class="fa fa-link" aria-hidden="true"></i></a>
* [Main\_Page](http://wiki.cs.vt.edu/wiki/Main_Page).
* [Printing](http://wiki.cs.vt.edu/wiki/Printing) from your desktop
* [Printing posters](http://wiki.cs.vt.edu/wiki/Printing#Specialty_Printers)

    * Send an email to
        > [techstaff@cs.vt.edu](mailto:techstaff@cs.vt.edu) with your
        > poster attached. A0 size is what most of us use

* [Department-provided web hosting](http://wiki.cs.vt.edu/wiki/Doc::Web_Hosting) for a personal website.

## <a name="Software"></a>Useful Software<a href="#Software"><i class="fa fa-link" aria-hidden="true"></i></a>

* [General Website](https://www.ita.vt.edu/Apps/WebObjects/NetSoftware)
* [Software](https://network.software.vt.edu)
* [SAR/POS](https://gpc.cs.vt.edu/#/sar)
* [Fellowships](https://cs.vt.edu/Academics/Graduate/Current/GradFellowship.html)
* [VT WordPress](http://wordpress.cs.vt.edu/create/)
* [iThenticate](https://shibboleth.turnitin.com/shibboleth/ithenticate)
* [Security Resources](https://security.vt.edu/resources.html)

## <a name="Templates"></a>Conference Presentation Templates<a href="#Templates"><i class="fa fa-link" aria-hidden="true"></i></a>
...
* [Reserving a room in Torg and McBryde](https://admin.cs.vt.edu/mrbs/index.php)
